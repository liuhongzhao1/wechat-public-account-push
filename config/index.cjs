...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx8c6105e35610b964',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '76555704c4f5876accf836ac7af0fd82',
  ...
  USERS: [
    {
      ...
      id: 'o1FuC6lI-UP622SeCV1hMe-XD5LI',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '',
      // 所在省份
      province: '广东',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '2001', date: '06-17',
        },
        {
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        { keyword: 'marry_day', date: ''2017-12-29' },
        // 退伍日
